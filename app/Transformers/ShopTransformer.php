...
class ShopTransformer implements Transformer
{
    ...
    public function transform($data)
    {
        ...
        $detailsImage = $hasDetailsImage ? $data->_source->media[1]->url : 'https://media.iamsterdam.com/ndtrc/Images/20101028/06d3a296-d940-4b9f-bb1d-16f6a0769b7f.jpg';
